...
IL_0013:
	...
	}
	{
		...
		L_8 = VirtualFuncInvoker0< Material_t18053F08F347D0DCA5E1140EC7EC4533DD8A14E3* >::Invoke(65 /* UnityEngine.Material TMPro.TMP_Text::get_fontSharedMaterial() */, L_7);
		il2cpp_codegen_runtime_class_init_inline(ShaderUtilities_t9BE0345DF949745FC0EB9A1119E204F2F129298F_il2cpp_TypeInfo_var);
...
IL_00f5:
	{
		...
		NullCheck(L_36);
		VirtualActionInvoker0::Invoke(100 /* System.Void TMPro.TMP_Text::UpdateCulling() */, L_36);
		// for (int i = 0; i < m_CullingUpdateQueue.Count; i++)
		int32_t L_37 = V_8;
